...
public class plotinoQuestions implements Serializable {
    ...
    public void runQuestion_1() throws IOException {
        ...
        instanceMap.clear();
        queryString = NAMESPACES
                + "SELECT DISTINCT  ?inst ?property "
                + "WHERE { ?inst plotino:greekTerm \"ὑπόστασις\" . "
...
//                + "ORDER BY ?termine ?property";
        ...
        for (ResultSet rs = qe.execSelect(); rs.hasNext();) {
            QuerySolution binding = rs.nextSolution();
            System.out.println("+++++++++++++++++++ " + binding.get("property").toString().split("#")[1]);
            System.out.println("+++++++++++++++++++ " + binding.get("inst").toString().split("#")[1]);
        }
        qe.close();
        System.out.println("+++++++++++++++++++ ");
//        res.clear();
...
//        }
    ...
    public void runQuestion_2() throws IOException {
        ...
        String queryString = NAMESPACES
                ...
                + "WHERE { plotino:"
                + query_2_param_1
                + " ?property plotino:" + query_2_param_2
                + " . } ORDER BY ?property ";

        // query al modello 
        executeQuery_2(queryString, "model", query_2_param_1, query_2_param_2);

        // query al modello esplicito
        executeQuery_2(queryString, "explicit", query_2_param_1, query_2_param_2);

        // query_2_param_2 PROP query_2_param_1
        queryString = NAMESPACES
                + "SELECT DISTINCT ?property "
                + "WHERE { plotino:"
                + query_2_param_2
                + " ?property plotino:" + query_2_param_1
                + " . } ORDER BY ?property ";

        // query al modello 
        executeQuery_2(queryString, "model", query_2_param_2, query_2_param_1);

        // query al modello esplicito
        executeQuery_2(queryString, "explicit", query_2_param_2, query_2_param_1);

        // query_2_param_1 PROP query_2_param_3
        queryString = NAMESPACES
                + "SELECT DISTINCT ?property "
                + "WHERE { plotino:"
                + query_2_param_1
                + " ?property plotino:" + query_2_param_3
                + " . } ORDER BY ?property ";

        // query al modello 
        executeQuery_2(queryString, "model", query_2_param_1, query_2_param_3);

        // query al modello esplicito
        executeQuery_2(queryString, "explicit", query_2_param_1, query_2_param_3);

        // query_2_param_3 PROP query_2_param_1
        queryString = NAMESPACES
                + "SELECT DISTINCT ?property "
                + "WHERE { plotino:"
                + query_2_param_3
        ...
        // query al modello 
        executeQuery_2(queryString, "model", query_2_param_3, query_2_param_1);

        // query al modello esplicito
        executeQuery_2(queryString, "explicit", query_2_param_3, query_2_param_1);

        // query_2_param_2 PROP query_2_param_3
        queryString = NAMESPACES
                + "SELECT DISTINCT ?property "
                + "WHERE { plotino:"
                + query_2_param_2
        ...
        // query al modello 
        executeQuery_2(queryString, "model", query_2_param_2, query_2_param_3);

        // query al modello esplicito
        executeQuery_2(queryString, "explicit", query_2_param_2, query_2_param_3);

        // query_2_param_3 PROP query_2_param_2
        queryString = NAMESPACES
                + "SELECT DISTINCT ?property "
                + "WHERE { plotino:"
                + query_2_param_3
        ...
        // query al modello 
        executeQuery_2(queryString, "model", query_2_param_3, query_2_param_2);

        // query al modello esplicito
        executeQuery_2(queryString, "explicit", query_2_param_3, query_2_param_2);
